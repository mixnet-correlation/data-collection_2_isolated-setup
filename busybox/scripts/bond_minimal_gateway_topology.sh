...
# use this as a job to bond the gateway
# these are hardcoded for the minimum topology to start
# pulled form the persistant volume
# for v1 it is what it is :)

GATEWAY_DETAILS=nym-gateway-node-details.txt
